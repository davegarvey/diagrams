...
providers=("onprem" "aws" "azure" "gcp" "firebase" "k8s" "alibabacloud" "oci" "programming" "saas" "elastic" "generic" "openstack" "outscale" "tyk")
...
for pvd in "${providers[@]}"; do
  ...
  # round the all png images for aws and tyk providers
